...
class DNN(nn.Module):
    ...
    def forward(self, z):
        ...
        out = self.ReLU(self.L_1(h))
        out = self.ReLU(self.L_2(out))
        out = self.ReLU(self.L_3(out))
        out = self.ReLU(self.L_4(out))
        out = self.ReLU(self.L_5(out))
        out = self.ReLU(self.L_6(out))
        out = self.ReLU(self.L_7(out))
        out = self.ReLU(self.L_8(out))
        out = self.ReLU(self.L_9(out))
        out = self.L_10(out)
        return out