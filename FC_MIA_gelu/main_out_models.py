...
if __name__ == '__main__':
    ...
    parser.add_argument('--base_path', type=str, default='./models_out_gelu_NTK/')  # where to save the experiment results
